...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-gold-primary/10 bg-bg-primary/60 px-5 py-3.5 backdrop-blur-xl">
